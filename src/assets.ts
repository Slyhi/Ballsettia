namespace Assets {
    export const textures: Dict<Preload.Texture> = {
        ...
        'slyhi/snowflake': {
            anchor: Vector2.CENTER,
            frames: {
                'slyhi/snowflake/0': { rect: rect(0, 0, 3, 3) },
                'slyhi/snowflake/1': { rect: rect(1, 0, 3, 3) },
                'slyhi/snowflake/2': { rect: rect(3, 0, 3, 3) },
                'slyhi/snowflake/4': { rect: rect(2, 1, 3, 3) },
                'slyhi/snowflake/5': { rect: rect(3, 3, 3, 3) },
                'slyhi/snowflake/6': { rect: rect(0, 4, 2, 2) },
                'slyhi/snowflake/7': { rect: rect(0, 0, 2, 2) },
                'slyhi/snowflake/8': { rect: rect(0, 1, 2, 2) },
            },
        },
        'slyhi/latteart': { 
            anchor: Vector2.CENTER,
        ...
        'slyhi/balls': {
            anchor: vec2(0.5, 0.25),
            frames: {
                'balls/americanfootball': { rect: rect(0, 0, 32, 32) },
        ...
        'slyhi/items': {
            ...
            frames: {
                ...
                'items/gnome': { rect: rect(16, 16, 16, 16) },
                // 24x24 sprite
                'items/infection': { rect: rect(56, 0, 24, 24) },
                'items/gnomedust': { rect: rect(80, 0, 24, 24) },
        ...
        'slyhi/palette': {
            anchor: Vector2.CENTER,
            frames: {
                'slyhi/palette/locked': { rect: rect(0, 0, 28, 42) },
                'slyhi/palette/box': { rect: rect(28, 0, 28, 42) },
                'slyhi/palette/display': { rect: rect(56, 0, 28, 42) },
                'slyhi/palette/cursor/friend': { rect: rect(84, 0, 28, 42) },
                'slyhi/palette/cursor/enemy': { rect: rect(112, 0, 28, 42) },
            }
        },
        'slyhi/paletteicon': { anchor: Vector2.CENTER },
        ...
        //Ballsettia Menu
        'slyhi/palettemenu': { url: 'slyhi/palettemenu.lci' },
